...
export const posts: Post[] = [
  {
    ...
    content: [
      ...
      "5. Let something do the boring part. Re-typing every due date is a waste. StudyPlan reads your Canvas and builds one calm daily plan for you — so you always know what's actually due. It's free to start.",
    ],
  },
  {
    ...
    content: [
      ...
      "That's the whole idea behind StudyPlan: it reads your Canvas and turns it into one calm daily plan, most urgent first. Everything that's due is always in it. Free to start.",
    ],
  },
  {
    ...
    content: [
      ...
      "If five minutes still feels like too much, StudyPlan does this part for you — connect Canvas once and it builds your week automatically. Free to start.",
    ],
  },
];
